                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="price_display" id="price_display" value="{{ old('price') ? 'Rp ' . number_format(old('price'), 0, ',', '.') : '' }}" placeholder="Rp 0" class="w-full pl-12 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-custom focus:border-transparent" autocomplete="off">
