            ...
            <div class="lg:pl-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-8">
                    @if($product->hasStock(1))
                        <a href="{{ route('payment.checkout', ['product_id' => $product->id, 'quantity' => 1]) }}" class="flex-1 px-8 py-4 bg-emerald-custom text-white font-bold rounded-xl hover:bg-[#0ea572] transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
